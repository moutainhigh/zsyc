...
public class OAuthResourceServerConfigurer extends ResourceServerConfigurerAdapter {
	private static final String RESOURCE_ID = "zsyc-api";
//	private static final String SECURED_READ_SCOPE = "#oauth2.hasScope('user')";

	@Value("${zsyc.oauth2.request.white-list}")
	private String[] whiteList;
	@Autowired
	ZSYCFilterInvocationSecurityMetadataSource zsycFilterInvocationSecurityMetadataSource;
	@Autowired
	ZSYCAccessDecisionManager zsycAccessDecisionManager;
	...
	public void configure(HttpSecurity http) throws Exception {
		http
				.authorizeRequests().antMatchers(this.whiteList).anonymous()
				.and()
