    ...
    <div>
        ...
        <div>
            <div style="padding: 25px;color: #303133">
                ...
                <span style="margin-left: 60px"><b>备注</b></span>
            </div>
            ...
            <div v-for="(order,index) in tableData" style="margin-bottom: 50px;color: #606266">
                ...
                <span style="margin: 20px">预约配送时间：2018-12-22 10:00-11:00 </span>
                <span style="margin: 20px"><a href="">详情</a></span>
                <div v-for="order in tableData" style="margin-left: 50px;margin-top: 10px;">
                    ...
                    <div style="margin-left: 30px;width:80px;display: inline-block">我是一个备注的点点滴滴</div>
                </div>
            </div>
        ...
        data(){
            return{
                ...
                tableData: [{
                    ...
                    img:require('../../static/img/cai.png'),
                    goodInfo: '中国有机芹菜西兰花新鲜蔬菜凉拌菜叶菜火锅食材 500g/份ddk大家记得记得记得点击豆浆机打底裤',
                    price: '21元/份',
                    number: '2份',
                    totalPrice: '4元',
                    isHasGood: '有货',
