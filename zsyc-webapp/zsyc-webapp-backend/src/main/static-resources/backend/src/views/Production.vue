...
<div id="app">
 <div>
     <div>统一生产条件：
     <span>
         <el-input v-model="beihuo" style="width: 200px;" placeholder="请输入生产条件"></el-input>
     </span>
    ...
    <div style="margin-top: 30px;">
        <el-radio-group v-model="radio3"  size="medium" @change="followup">
            <el-radio-button label="待生产订单"></el-radio-button>
            <el-radio-button label="已生产订单"></el-radio-button>
        </el-radio-group>
    </div>

    <div v-for="(item,index) in list" v-if="index<3"  :key='index' style="  margin-top:10px;width: 1600px;height: 400px;border:solid 1px;border-color: rgba(121,121,121,0.56)">
    <div style="margin-top: 10px;">
        <span>{{item.num}}、</span><span style="margin-left: 10px;"> 订单号</span><font color="#00bfff" style="margin-left: 10px">dd201832</font>
        ...
        <span v-if="item.wancheng==='已完成'" style="margin-left: 250px"><el-button type="info" disabled>已完成</el-button></span>
        <span v-else="item.wancheng==='未完成'"> <el-button style="margin-left: 250px" type="primary">点击完成</el-button></span>
        <span></span>
    </div>

        <div v-for="item2 in fi" style="margin-top: 60px;">
<img :src="item2.img" style="margin-left:30px;margin-top:20px; width:100px;height: 100px;">
                <div style="margin-left: 150px; margin-top:-80px;width: 300px ;">中国有机芹菜西兰花新鲜蔬菜凉拌叶菜火锅食材 500g/份</div>
                    <div style="margin-top: -40px;margin-left: 330px">
                <div style="margin-left: 190px;width: 100px;margin-top: -22px;">{{item2.porce}}g/份</div>


                    <div style="margin-left: 480px;margin-top: -21px;width: 100px;">{{item2.fen}}份</div>
                     <el-button style="margin-left: 700px;margin-top: -50px" v-if="item.wancheng==='已完成'" type="info" disabled>缺货登记</el-button>
                       <el-button  style="margin-left: 700px;margin-top: -50px" v-else="item.wancheng==='未完成'" type="primary">缺货登记</el-button>
                    </div>
