...
//            logger.error(e.getMessage());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 生成二维码图片，并返回图片路径
            String pathName = generateQRCode(text, width, height, format, directory.getCanonicalPath() + "\\zsyc-common\\src\\main\\java\\com\\zsyc\\temp\\new.png");
    ...
    public static String createQRCode(String url, int width, int height, String format) throws Exception {

        File directory = new File("");//设定为当前文件夹
        // 生成二维码图片，并返回图片路径
        String pathName = generateQRCode(url, width, height, format, directory.getCanonicalPath() + "\\zsyc-common\\src\\main\\java\\com\\zsyc\\temp\\store.png");
        return pathName;
    }
